...
def generate_page_recurs(dir_path_content, template_path, dest_dir_path):
    ...
    for item in os.listdir(dir_path_content):
        ...
        if os.path.isfile(origin_path):
            ...
            generate_page(origin_path,template_path,dest_path)
        elif os.path.isdir(origin_path):
            dest_path = os.path.join(dest_dir_path, item)
            generate_page_recurs(origin_path,template_path,dest_path)
